...
from oapi_v1.models.v1_local_subject_access_review import V1LocalSubjectAccessReview
...
class TestV1LocalSubjectAccessReview(unittest.TestCase):
    ...
    def testV1LocalSubjectAccessReview(self):
        ...
        """
        model = oapi_v1.models.v1_local_subject_access_review.V1LocalSubjectAccessReview()
