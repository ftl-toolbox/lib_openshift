...
from oapi_v1.models.v1_downward_api_volume_file import V1DownwardAPIVolumeFile
...
class TestV1DownwardAPIVolumeFile(unittest.TestCase):
    ...
    def testV1DownwardAPIVolumeFile(self):
        ...
        """
        model = oapi_v1.models.v1_downward_api_volume_file.V1DownwardAPIVolumeFile()
