...
class V1RoleBinding(object):
    ...
    def user_names(self):
        """
        Gets the user_names of this V1RoleBinding.
        UserNames holds all the usernames directly bound to the role

        :return: The user_names of this V1RoleBinding.
        :rtype: list[str]
        """
    ...
    def user_names(self, user_names):
        """
        Sets the user_names of this V1RoleBinding.
        UserNames holds all the usernames directly bound to the role

        :param user_names: The user_names of this V1RoleBinding.
        :type: list[str]
        """
    ...
    def group_names(self):
        """
        Gets the group_names of this V1RoleBinding.
        GroupNames holds all the groups directly bound to the role

        :return: The group_names of this V1RoleBinding.
        :rtype: list[str]
        """
    ...
    def group_names(self, group_names):
        """
        Sets the group_names of this V1RoleBinding.
        GroupNames holds all the groups directly bound to the role

        :param group_names: The group_names of this V1RoleBinding.
        :type: list[str]
        """
