...
from apis_batch_v1.models.v1_glusterfs_volume_source import V1GlusterfsVolumeSource
...
class TestV1GlusterfsVolumeSource(unittest.TestCase):
    ...
    def testV1GlusterfsVolumeSource(self):
        ...
        """
        model = apis_batch_v1.models.v1_glusterfs_volume_source.V1GlusterfsVolumeSource()
