...
from lib_openshift.apis.apiv1_api import Apiv1Api


class TestApiv1Api(unittest.TestCase):
    """ Apiv1Api unit test stubs """

    def setUp(self):
        self.api = lib_openshift.apis.apiv1_api.Apiv1Api()
