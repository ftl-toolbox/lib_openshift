...
class V1Endpoints(object):
	...
	api.create_namespaced_endpoint(self, namespace)


    def replace(self, api, namespace):
	api.replace_namespaced_endpoint(self, namespace)

    @staticmethod
    def delete(api, delete_options, namespace, name):
        api.delete_namespaced_endpoint(delete_options, namespace, name)
    def to_dict(self):
        """
