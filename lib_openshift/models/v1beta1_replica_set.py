...
class V1beta1ReplicaSet(object):
    ...
    operations = [
        {
            ...
            'type': 'create',
            'method': 'create_namespaced_replicaset',
            'namespaced': True
        },
        {
            'class': 'ApisExtensionsV1beta1',
            'type': 'update',
            'method': 'replace_namespaced_replicaset',
            'namespaced': True
        },
        {
            'class': 'ApisExtensionsV1beta1',
            'type': 'delete',
            'method': 'delete_namespaced_replicaset',
            'namespaced': True
        },
        {
            'class': 'ApisExtensionsV1beta1',
            'type': 'read',
            'method': 'get_namespaced_replicaset',
            'namespaced': True
        },
        {
            'class': 'ApisExtensionsV1beta1',
    ...
    def to_dict(self):
        ...
        for attr, _ in iteritems(V1beta1ReplicaSet.swagger_types):
