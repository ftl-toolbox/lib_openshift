...
class V1ReplicationController(object):
	...
	api.create_namespaced_replicationcontroller(self, namespace)


    def replace(self, api, namespace):
	api.replace_namespaced_replicationcontroller(self, namespace)

    @staticmethod
    def delete(api, delete_options, namespace, name):
        api.delete_namespaced_replicationcontroller(delete_options, namespace, name)
    def to_dict(self):
        """
