...
class V1ReplicationController(object):
    ...
    operations = [
        {
            'class': 'ApiV1',
            'type': 'create',
            'method': 'create_replicationcontroller',
            'namespaced': False
        },
        {
            'class': 'ApiV1',
        ...
        },
        {
            'class': 'ApiV1',
            'type': 'delete',
            'method': 'delete_namespaced_replicationcontroller',
            'namespaced': True
        },
        {
            'class': 'ApiV1',
        ...
        },
        {
            'class': 'ApiV1',
            'type': 'create',
            'method': 'create_namespaced_replicationcontroller',
            'namespaced': True
        },
    ]
    ...
    def to_dict(self):
        ...
        for attr, _ in iteritems(V1ReplicationController.swagger_types):
