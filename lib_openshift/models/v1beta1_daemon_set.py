...
class V1beta1DaemonSet(object):
	...
	api.create_namespaced_daemonset(self, namespace)


    def replace(self, api, namespace):
	api.replace_namespaced_daemonset(self, namespace)

    @staticmethod
    def delete(api, delete_options, namespace, name):
        api.delete_namespaced_daemonset(delete_options, namespace, name)
    def to_dict(self):
        """
