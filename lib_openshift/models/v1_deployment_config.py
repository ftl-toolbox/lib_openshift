...
class V1DeploymentConfig(object):
	...
	api.create_namespaced_deploymentconfig(self, namespace)


    def replace(self, api, namespace):
	api.replace_namespaced_deploymentconfig(self, namespace)

    @staticmethod
    def delete(api, delete_options, namespace, name):
        api.delete_namespaced_deploymentconfig(delete_options, namespace, name)
    def to_dict(self):
        """
