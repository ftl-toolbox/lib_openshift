...
class V1NetNamespaceList(object):
    ...
    def kind(self):
        """
        Gets the kind of this V1NetNamespaceList.
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: http://releases.k8s.io/release-1.2/docs/devel/api-conventions.md#types-kinds

        :return: The kind of this V1NetNamespaceList.
        :rtype: str
        """
        return self._kind
    ...
    def kind(self, kind):
        """
        Sets the kind of this V1NetNamespaceList.
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: http://releases.k8s.io/release-1.2/docs/devel/api-conventions.md#types-kinds

        :param kind: The kind of this V1NetNamespaceList.
        :type: str
        """
    ...
    def api_version(self):
        """
        Gets the api_version of this V1NetNamespaceList.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: http://releases.k8s.io/release-1.2/docs/devel/api-conventions.md#resources

        :return: The api_version of this V1NetNamespaceList.
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        """
        Sets the api_version of this V1NetNamespaceList.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: http://releases.k8s.io/release-1.2/docs/devel/api-conventions.md#resources

        :param api_version: The api_version of this V1NetNamespaceList.
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in iteritems(V1NetNamespaceList.swagger_types):
