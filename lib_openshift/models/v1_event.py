...
class V1Event(object):
	...
	self.operations = {
            {method&#x3D;watch_namespaced_watch_event, type&#x3D;read, class&#x3D;ApiV1, namespaced&#x3D;true}
	}
	self.operations = {
            {method&#x3D;create_event, type&#x3D;create, class&#x3D;ApiV1, namespaced&#x3D;false}
	}
	self.operations = {
            {method&#x3D;replace_namespaced_event, type&#x3D;update, class&#x3D;ApiV1, namespaced&#x3D;true}
	}
	self.operations = {
            {method&#x3D;delete_namespaced_event, type&#x3D;delete, class&#x3D;ApiV1, namespaced&#x3D;true}
	}
	self.operations = {
            {method&#x3D;get_namespaced_event, type&#x3D;read, class&#x3D;ApiV1, namespaced&#x3D;true}
	}
	self.operations = {
            {method&#x3D;patch_namespaced_event, type&#x3D;patch, class&#x3D;ApiV1, namespaced&#x3D;true}
	}
	self.operations = {
            {method&#x3D;create_namespaced_event, type&#x3D;create, class&#x3D;ApiV1, namespaced&#x3D;true}
	}
