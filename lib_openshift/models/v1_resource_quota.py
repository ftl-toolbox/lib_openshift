...
class V1ResourceQuota(object):
	...
	api.create_namespaced_resourcequota(self, namespace)


    def replace(self, api, namespace):
	api.replace_namespaced_resourcequota(self, namespace)

    @staticmethod
    def delete(api, delete_options, namespace, name):
        api.delete_namespaced_resourcequota(delete_options, namespace, name)
    def to_dict(self):
        """
