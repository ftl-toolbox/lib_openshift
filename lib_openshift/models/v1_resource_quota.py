...
class V1ResourceQuota(object):
    ...
    operations = [
        {
            'class': 'ApiV1',
            'type': 'create',
            'method': 'create_resourcequota',
            'namespaced': False
        },
        {
            'class': 'ApiV1',
            'type': 'create',
            'method': 'create_namespaced_resourcequota',
            'namespaced': True
        },
        {
            'class': 'ApiV1',
        ...
        },
        {
            'class': 'ApiV1',
            'type': 'delete',
            'method': 'delete_namespaced_resourcequota',
            'namespaced': True
        },
        {
            'class': 'ApiV1',
    ...
    def to_dict(self):
        ...
        for attr, _ in iteritems(V1ResourceQuota.swagger_types):
