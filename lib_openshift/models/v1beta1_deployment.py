...
class V1beta1Deployment(object):
	...
	api.create_namespaced_deployment(self, namespace)


    def replace(self, api, namespace):
	api.replace_namespaced_deployment(self, namespace)

    @staticmethod
    def delete(api, delete_options, namespace, name):
        api.delete_namespaced_deployment(delete_options, namespace, name)
    def to_dict(self):
        """
