...
class V1PodTemplate(object):
    ...
    operations = [
        {
            'class': 'ApiV1',
            'type': 'create',
            'method': 'create_podtemplate',
            'namespaced': False
        },
        {
            'class': 'ApiV1',
            'type': 'update',
            'method': 'replace_namespaced_podtemplate',
            'namespaced': True
        },
        {
            'class': 'ApiV1',
            'type': 'delete',
            'method': 'delete_namespaced_podtemplate',
            'namespaced': True
        },
        {
            'class': 'ApiV1',
            'type': 'read',
            'method': 'get_namespaced_podtemplate',
            'namespaced': True
        },
        {
            'class': 'ApiV1',
    ...
    def to_dict(self):
        ...
        for attr, _ in iteritems(V1PodTemplate.swagger_types):
