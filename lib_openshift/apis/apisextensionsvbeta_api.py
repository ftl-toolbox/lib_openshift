...
class ApisextensionsvbetaApi(object):
    ...
    def read_namespaced_scale_scale_3(self, namespace, name, **kwargs):
        """
        read scale of the specified Scale
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.read_namespaced_scale_scale_3(namespace, name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_namespaced_scale_scale_3" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `read_namespaced_scale_scale_3`")
        # verify the required parameter 'name' is set
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `read_namespaced_scale_scale_3`")
    ...
    def replace_namespaced_scale_scale_6(self, body, namespace, name, **kwargs):
        """
        replace scale of the specified Scale
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.replace_namespaced_scale_scale_6(body, namespace, name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method replace_namespaced_scale_scale_6" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `replace_namespaced_scale_scale_6`")
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `replace_namespaced_scale_scale_6`")
        # verify the required parameter 'name' is set
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `replace_namespaced_scale_scale_6`")
