...
**spec** | [**V1beta1HorizontalPodAutoscalerSpec**](V1beta1HorizontalPodAutoscalerSpec.md) | behaviour of autoscaler. More info: http://releases.k8s.io/release-1.2/docs/devel/api-conventions.md#spec-and-status. | [optional] 
