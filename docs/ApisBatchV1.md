...
[**deletecollection_namespaced_job**](ApisBatchV1.md#deletecollection_namespaced_job) | **DELETE** /apis/batch/v1/namespaces/{namespace}/jobs | delete collection of Job
[**get_api_resources**](ApisBatchV1.md#get_api_resources) | **GET** /apis/batch/v1 | get available resources
[**list_job**](ApisBatchV1.md#list_job) | **GET** /apis/batch/v1/jobs | list or watch objects of kind Job
[**list_namespaced_job**](ApisBatchV1.md#list_namespaced_job) | **GET** /apis/batch/v1/namespaces/{namespace}/jobs | list or watch objects of kind Job
...
[**read_namespaced_job**](ApisBatchV1.md#read_namespaced_job) | **GET** /apis/batch/v1/namespaces/{namespace}/jobs/{name} | read the specified Job
...
[**watch_job_list**](ApisBatchV1.md#watch_job_list) | **GET** /apis/batch/v1/watch/jobs | watch individual changes to a list of Job
[**watch_namespaced_job**](ApisBatchV1.md#watch_namespaced_job) | **GET** /apis/batch/v1/watch/namespaces/{namespace}/jobs/{name} | watch changes to an object of kind Job
[**watch_namespaced_job_list**](ApisBatchV1.md#watch_namespaced_job_list) | **GET** /apis/batch/v1/watch/namespaces/{namespace}/jobs | watch individual changes to a list of Job
...
try: 
    ...
    print "Exception when calling ApisBatchV1->deletecollection_namespaced_job: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApisBatchV1->get_api_resources: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApisBatchV1->list_job: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApisBatchV1->list_namespaced_job: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApisBatchV1->read_namespaced_job: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApisBatchV1->watch_job_list: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApisBatchV1->watch_namespaced_job: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApisBatchV1->watch_namespaced_job_list: %s\n" % e
```
