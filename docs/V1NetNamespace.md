...
**netname** | **str** | NetName is the name of the network namespace | 
**netid** | **int** | NetID is the network identifier of the network namespace assigned to each overlay network packet | 
