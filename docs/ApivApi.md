...
[**create_binding**](ApivApi.md#create_binding) | **POST** /api/v1/bindings | create a Binding
[**create_config_map**](ApivApi.md#create_config_map) | **POST** /api/v1/configmaps | create a ConfigMap
[**create_endpoints**](ApivApi.md#create_endpoints) | **POST** /api/v1/endpoints | create a Endpoints
[**create_event**](ApivApi.md#create_event) | **POST** /api/v1/events | create a Event
[**create_limit_range**](ApivApi.md#create_limit_range) | **POST** /api/v1/limitranges | create a LimitRange
...
[**create_namespaced_security_context_constraints**](ApivApi.md#create_namespaced_security_context_constraints) | **POST** /api/v1/securitycontextconstraints | create a SecurityContextConstraints
...
[**create_persistent_volume_claim**](ApivApi.md#create_persistent_volume_claim) | **POST** /api/v1/persistentvolumeclaims | create a PersistentVolumeClaim
[**create_pod**](ApivApi.md#create_pod) | **POST** /api/v1/pods | create a Pod
[**create_pod_template**](ApivApi.md#create_pod_template) | **POST** /api/v1/podtemplates | create a PodTemplate
[**create_replication_controller**](ApivApi.md#create_replication_controller) | **POST** /api/v1/replicationcontrollers | create a ReplicationController
[**create_resource_quota**](ApivApi.md#create_resource_quota) | **POST** /api/v1/resourcequotas | create a ResourceQuota
[**create_secret**](ApivApi.md#create_secret) | **POST** /api/v1/secrets | create a Secret
[**create_service**](ApivApi.md#create_service) | **POST** /api/v1/services | create a Service
[**create_service_account**](ApivApi.md#create_service_account) | **POST** /api/v1/serviceaccounts | create a ServiceAccount
...
[**delete_namespaced_security_context_constraints**](ApivApi.md#delete_namespaced_security_context_constraints) | **DELETE** /api/v1/securitycontextconstraints/{name} | delete a SecurityContextConstraints
...
[**deletecollection_namespaced_security_context_constraints**](ApivApi.md#deletecollection_namespaced_security_context_constraints) | **DELETE** /api/v1/securitycontextconstraints | delete collection of SecurityContextConstraints
...
[**list_namespaced_security_context_constraints**](ApivApi.md#list_namespaced_security_context_constraints) | **GET** /api/v1/securitycontextconstraints | list or watch objects of kind SecurityContextConstraints
...
[**patch_namespaced_security_context_constraints**](ApivApi.md#patch_namespaced_security_context_constraints) | **PATCH** /api/v1/securitycontextconstraints/{name} | partially update the specified SecurityContextConstraints
...
[**read_namespaced_security_context_constraints**](ApivApi.md#read_namespaced_security_context_constraints) | **GET** /api/v1/securitycontextconstraints/{name} | read the specified SecurityContextConstraints
...
[**replace_namespaced_security_context_constraints**](ApivApi.md#replace_namespaced_security_context_constraints) | **PUT** /api/v1/securitycontextconstraints/{name} | replace the specified SecurityContextConstraints
...
[**watch_namespaced_security_context_constraints**](ApivApi.md#watch_namespaced_security_context_constraints) | **GET** /api/v1/watch/securitycontextconstraints/{name} | watch changes to an object of kind SecurityContextConstraints
[**watch_namespaced_security_context_constraints_list**](ApivApi.md#watch_namespaced_security_context_constraints_list) | **GET** /api/v1/watch/securitycontextconstraints | watch individual changes to a list of SecurityContextConstraints
...
api_instance = lib_openshift.ApivApi()
...
try: 
    ...
    print "Exception when calling ApivApi->create_binding: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_config_map: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_endpoints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_event: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_limit_range: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_namespaced_security_context_constraints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_persistent_volume_claim: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_pod: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_pod_template: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_replication_controller: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_resource_quota: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_secret: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_service: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->create_service_account: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->delete_namespaced_security_context_constraints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->deletecollection_namespaced_security_context_constraints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->list_namespaced_security_context_constraints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->patch_namespaced_security_context_constraints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->read_namespaced_security_context_constraints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->replace_namespaced_security_context_constraints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_namespaced_security_context_constraints: %s\n" % e
```
...
try: 
    ...
    print "Exception when calling ApivApi->watch_namespaced_security_context_constraints_list: %s\n" % e
```
