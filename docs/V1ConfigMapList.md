...
**metadata** | [**UnversionedListMeta**](UnversionedListMeta.md) | More info: http://releases.k8s.io/release-1.2/docs/devel/api-conventions.md#metadata | [optional] 
**items** | [**list[V1ConfigMap]**](V1ConfigMap.md) | Items is the list of ConfigMaps. | [optional] 
